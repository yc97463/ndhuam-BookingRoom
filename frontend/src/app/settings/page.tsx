        ...
        <div className="container mx-auto p-4 max-w-3xl">
            <div className="flex justify-between items-center mb-6">
                ...
                <button
                    onClick={saveRooms}
                    disabled={isSaving}
                    className="px-4 py-2 bg-blue-500 text-white rounded-full flex items-center gap-2 hover:bg-blue-600 disabled:opacity-50"
                >
                    {isSaving ? (
                        <>
            ...
            <div className="bg-white rounded-lg shadow">
                        ...
                        >
                            ...
                            <div className="flex gap-4 pl-10">
                                ...
                                <button
                                    ...
                                    className={`px-3 py-1 rounded text-sm min-w-[4rem] ${room.isActive
                ...
                <div className="p-4 border-t">
                    <button
                        onClick={addRoom}
                        className="w-full py-2 text-gray-500 hover:text-gray-700 flex items-center justify-center gap-2"
                    >
                        <Plus size={20} />
                        新增空間
                    </button>
